...
texture_files = os.listdir("../isaacgym/assets/textures/")
loaded_texture_handle_list = []
for file in texture_files:
    if file.endswith(".jpg"):
        loaded_texture_handle_list.append(gym.create_texture_from_file(sim, os.path.join("../isaacgym/assets/textures/", file)))
