...
num_envs = 2
spacing = 1.0
env_lower = gymapi.Vec3(-2 * spacing, 0.0, -spacing)
env_upper = gymapi.Vec3(2 * spacing, 0.4 * spacing, spacing)
...
for i in range(num_envs):
    ...
    pose.p = gymapi.Vec3(-i * 4, 0.41+i, 0.0)
    pose.r = gymapi.Quat.from_euler_zyx(0.5 * math.pi, 0, 0)
    ahandle = gym.create_actor(env, asset, pose, "cabinet", 1, 0)
